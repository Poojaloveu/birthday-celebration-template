...
function Gallery({ isActive }) {
  ...
  const photos = [
    { src: "/images/photo1.jpg", alt: "nibbi 1" },
    { src: "/images/photo2.jpg", alt: "nibbi 2" },
    { src: "/images/photo4.jpg", alt: "gadhedi 3" },
    { src: "/images/photo5.jpg", alt: "gadhedi 4" },
    { src: "/images/photo6.jpg", alt: "gadhedi 5" },
    { src: "/images/photo7.jpg", alt: "gadhedi 6" },
  ];
